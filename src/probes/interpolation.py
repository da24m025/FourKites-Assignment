...
if __name__ == '__main__':
    ...
    p.add_argument('--out', type=str, default=None, help='Output plot path (auto-generated if not provided)')
    ...
    if not args.no_save:
        ...
        ckpt_a_name = Path(args.ckpt_a).stem
        ckpt_b_name = Path(args.ckpt_b).stem
        
        if args.out is None:
            args.out = str(out_dir / f"interp_{ckpt_a_name}_to_{ckpt_b_name}.png")
